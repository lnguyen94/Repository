 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Lien Nguyen");
		  toPrint += p1.toString("lnguyen66");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Rudolph Elliott Childre");
		  toPrint += p2.toString("rchildre3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Mika Munch");
		  toPrint += p3.toString("mmunch3");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Shree Nadkarni");
                  toPrint += p4.toString("snadkarni7");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Sam Ford");
                  toPrint += p5.toString("sford34");
